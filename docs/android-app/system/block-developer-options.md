...
## What it does
- Applies `UserManager.DISALLOW_DEBUGGING_FEATURES`.
- Persists `system.developer_options_blocked` in `ConfigStore`.

## How it runs
- Toggle in `PrivacyFragment` calls `SystemToggleHandler.onDeveloperOptionsToggle`.
